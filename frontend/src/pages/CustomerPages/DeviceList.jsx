import { Tv2, Gamepad2, Monitor, Loader2, WifiOff } from "lucide-react";
...
export default function DeviceList() {
  ...
  return (
    <>
      <PageMeta title="IZIReps | Devices" description="Daftar Perangkat IZIReps" />
      <PageBreadcrumb items={[{ label: "Daftar Perangkat", path: "/device-list" }]} />
      
      <section id="devices" className="bg-base-100 py-16 sm:py-20 rounded-2xl">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-lg text-sm leading-relaxed text-base-content/70">
              Lihat ketersediaan seluruh unit kami secara real-time.
            </p>
          </div>
