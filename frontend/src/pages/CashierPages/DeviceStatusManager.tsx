...
import { Button, EmptyState, Spinner, ConfirmDialog } from '../../components/common'
import { useState } from 'react'

// ─── Komponen utama ───────────────────────────────────────────────────────────
// Kasir hanya bisa ubah status available ↔ maintenance.
// Edit data perangkat (nama, tarif, IP) hanya bisa dilakukan owner.
// ⚠️ SESUAIKAN:
//   - PATCH /api/devices/:id/status → pastikan body: { status, note }
//   - Endpoint ini harus diberi akses 'cashier' di middleware backend
