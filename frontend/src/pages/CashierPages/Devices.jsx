...
function DeviceCard({ device, activeSession }) {
  ...
  return (
    <div
      className={`rounded-2xl border-2 p-4 flex flex-col gap-3 transition-all ${deviceStatusCard[device.status]}`}
    >
      <div className="flex items-start justify-between gap-2">
        ...
        <span
          className={`text-xs font-medium px-2 py-1 rounded-full ring-1 flex-shrink-0 ${deviceStatusBadge[device.status]}`}
        >
...
export default function DeviceGrid() {
  ...
  return (
    <>
      <PageBreadcrumb
        pageDescription="Daftar semua perangkat"
        items={[{ label: "Perangkat", path: "/devices" }]}
      />
