...
import { TbLayoutDashboard, TbCalendarEvent, TbReceipt, TbCoffee } from "react-icons/tb";
...
const AppSidebar: React.FC = () => {
  ...
  const [openSubmenu, setOpenSubmenu] = useState<{
    type: "main" | "booking" | "transaction" | "other";
    index: number;
  } | null>(null);
  ...
  useEffect(() => {
    ...
    ["main", "booking", "transaction", "other"].forEach((menuType) => {
      const items = menuType === "main" ? mainItems : menuType === "booking" ? bookingItems : menuType === "transaction" ? transactionItems : otherItems;
      items.forEach((nav, index) => {
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({
                type: menuType as "main" | "booking" | "transaction" | "other",
                index,
              });
              submenuMatched = true;
            }
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "booking" | "transaction" | "other") => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "booking" | "transaction" | "other") => (
