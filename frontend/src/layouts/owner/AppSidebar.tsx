...
const reportItems: NavItem[] = [
  {
    ...
    name: "Revenue",
    path: "/owner/reports?tab=revenue",
  },
  {
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "reports", "management"].forEach((menuType) => {
      const items = menuType === "main" ? navItems : menuType === "reports" ? reportItems : managementItems;
      items.forEach((nav, index) => {
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({
                type: menuType as "main" | "reports" | "management",
                index,
              });
              submenuMatched = true;
            }
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "reports" | "management") => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "reports" | "management") => (
