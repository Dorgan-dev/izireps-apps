...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | IZIReps - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for IZIReps - React.js Tailwind CSS Admin Dashboard Template"
      />
