...
function BookingSesiItem({ booking, onMulaiSesi }) {
  ...
  return (
    <div
      className={`p-4 rounded-xl border ${timeLeft.status === "warning" ? "border-error-300 bg-error-50 dark:bg-error-950/20" : "border-gray-200"}`}
    >
      ...
      {timeLeft.status === "warning" && (
        <div className="mt-3 text-xs text-error-600 dark:text-error-400 font-medium animate-pulse">
          ⚠️ Pelanggan terlambat! Otomatis batal & DP hangus dalam{" "}
