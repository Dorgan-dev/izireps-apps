  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 text-sm text-blue-700">
        ℹ️ Kasir hanya dapat mengubah status perangkat antara{" "}
        <strong>Tersedia</strong> dan <strong>Perbaikan</strong>. Untuk edit
        data perangkat atau tarif, hubungi owner.
      </div>
              ...
              {all.map((device, idx) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-center">
                    <span
                      className={`text-xs font-medium px-2 py-1 rounded-full ring-1 ${deviceStatusBadge[device.status]}`}
                    >
