...
import { formatDuration, getElapsedMinutes, sessionStatusLabel, sessionStatusBadge } from '../../utils'
...
// ─── Kartu sesi aktif ─────────────────────────────────────────────────────────
export default function SessionCard({ session, onAddFnb }: { session: PlaySession, onAddFnb: (s: PlaySession) => void }) {
