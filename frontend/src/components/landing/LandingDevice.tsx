...
import { Tv2, Gamepad2, Monitor, ArrowRight, Loader2, WifiOff } from 'lucide-react';
...
function getTypeConfig(psType: string) {
  switch (psType) {
    case 'PS3':
      return { icon: Monitor, color: 'text-orange-500', bg: 'bg-orange-50 dark:bg-orange-950/40', emoji: '🕹️' };
    case 'PS5':
      return { icon: Tv2, color: 'text-success-600 dark:text-success-400', bg: 'bg-success-50 dark:bg-success-950/40', emoji: '🎮' };
    case 'PS4':
    default:
      return { icon: Gamepad2, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-950/40', emoji: '🕹️' };
  }
}
