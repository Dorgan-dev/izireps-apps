  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 bg-white dark:bg-gray-900">
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-800/60">
        ...
        {/* Baris 2: Delete Account */}
        <div className="flex flex-col gap-4 py-5 sm:flex-row sm:items-center sm:justify-between last:pb-0">
          <div className="max-w-xl">
            <h5 className="text-sm font-semibold text-gray-800 dark:text-white/90 mb-1">
              Delete account
            </h5>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm font-medium text-red-600 shadow-theme-xs hover:bg-red-50 dark:border-red-500/30 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-red-500/[0.04] w-full sm:w-auto"
          >
            {/* Icon Trash / Delete */}
            <svg
              className="stroke-current"
