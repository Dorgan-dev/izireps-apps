...
const BookingHistory = lazy(() =>
  import("../pages/CustomerPages/BookingHistory")
);
const BookingHistoryDetail = lazy(() =>
  import("../pages/CustomerPages/BookingHistoryDetail")
);
        ...
        children: [
          ...
          { path: "device/detail/:id", element: <S><PublicDeviceDetail /></S> },
          {
            ...
            children: [
              {
                path: "profile",
                element: <S><UserProfile /></S>,
              },
              {
                path: "my-bookings",
                element: <S><BookingHistory /></S>,
              },
              {
                path: "my-bookings/:id",
                element: <S><BookingHistoryDetail /></S>,
              },
            ],
          },
