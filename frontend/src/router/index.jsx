...
const PublicDeviceDetail = lazy(
  () => import("../pages/PublicPages/DeviceDetail"),
);
const UserProfile = lazy(() => import("../pages/PublicPages/UserProfiles"));
const DeviceSchedule = lazy(
  () => import("../pages/PublicPages/DeviceSchedule"),
);
...
const CashierCheckout = lazy(
  () => import("../pages/CashierPages/SessionDetail"),
);
const CashierFnb = lazy(() => import("../pages/CashierPages/Fnb"));
const CashierTransactions = lazy(
  () => import("../pages/CashierPages/Transactions"),
);
